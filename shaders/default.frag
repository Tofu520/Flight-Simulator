...
void main()
{
    ...
    vec3 lightDir = normalize(lightPos); // this is the sun direction

    // Use your existing directional light function
    vec4 light = direcLight(); // this already multiplies diffuse + specular + ambient
